...
|-------------|------------------------|----------------|
| `src/components/About.astro` | Current postdoc research details (replace generic sentence) | Yellow callout on page with file path |
| `src/components/About.astro` | Forward-looking research vision paragraph | Yellow callout on page with file path |
| `src/components/Research.astro` | Air-Sea Interaction theme description + figures | Yellow callout on page with file path |
| `cv/cv.tex` | Education details (department, year) | Orange-bordered box in PDF with `cv/cv.tex` path |
| `cv/cv.tex` | Employment date ranges | Orange-bordered box in PDF with `cv/cv.tex` path |
| `cv/cv.tex` | Additional publications, talks, teaching, awards | Orange-bordered box in PDF with `cv/cv.tex` path |
...
<BaseLayout
  title="Chan-Ye (Chris) Ohh — Postdoctoral Researcher"
...
<section class="hero" id="hero">
  <div class="hero__inner container">
    <div class="hero__text">
      ...
      <p class="hero__title">Postdoctoral Researcher</p>
      <p class="hero__affiliation">Scripps Institution of Oceanography, UC San Diego</p>
...
<section class="about" id="about">
  <div class="container">
    ...
    <p>
      I received my PhD from the University of Southern California, where I
      worked with Prof. Geoffrey Spedding in the Stratified Fluids Laboratory.
      My dissertation focused on the wakes generated by bluff bodies moving
      through stratified environments &mdash; a problem with direct connections
      to underwater vehicle hydrodynamics and oceanic turbulence. Using towed
      experiments in a large stratified water tank and dynamic mode decomposition
      (DMD), I developed new approaches for identifying and classifying wake
      regimes from limited flow measurements.
    </p>

    <p>
      At Scripps, I am extending these methods to air&ndash;sea interaction
      problems, investigating how the techniques I developed for stratified wake
      analysis can inform our understanding of upper-ocean dynamics and
      atmosphere&ndash;ocean coupling.
    </p>

    <div class="todo">
      <span class="todo__file">src/components/About.astro</span>
      <p class="todo__text">
        Replace the paragraph above with 1-2 sentences about your specific
        postdoc research direction at Scripps.
      </p>
    </div>
  ...
  <div class="container">
    ...
    >
      <p>
        ...
        approaches to problems at the atmosphere&ndash;ocean boundary.
      </p>
      <div class="todo">
        <span class="todo__file">src/components/Research.astro</span>
        <p class="todo__text">
          Expand this section with your specific Air-Sea Interaction research
          description and its broader significance (climate, weather, carbon cycle, etc.).
          Add figures when available.
        </p>
      </div>
      <p class="theme__papers">
        <strong>Lab:</strong>
...
\cventry{University of Southern California}{Los Angeles, CA}{Ph.D., [Department]}{[Year]}

\cvtodo{Fill in department, graduation year, and any additional degrees (B.S., M.S., etc.)}
...
\cvtodo{Add talks, invited seminars, and other presentations.}

\cvtodo{Add additional sections as needed: Teaching, Awards \& Honors, Service \& Outreach, Skills.}
